...
public class GameArenaSystem {
    ...
    public static void main(String[] args) {
        ...
        cart = new Cart();
        Event[] events = {new Event("Billy Joel World Tour", "Billy Joel concert ", "October 9, 2023 12pm", "Concert", 3, 100, 20, 0), new Event("Call Of Duty Major 3\nTournament", "Esports ", "June 26, 2023 7pm", "Tournament ", 5, 50, 25, 1), new Event("Kendrick Lamar Good Kid\nM.A.A.D City ", "Hip Hop ", "July 30, 2023 9pm", "Concert ", 4, 80, 20, 2), new Event("Drake & 21 Savage\nBroke Boys Tour ", "Rap ", "October 31, 2023 10pm", "Concert ", 3, 60, 20, 3)};
