...
class EventTest {
    ...
    void getEventDetails() {
        ...
        assertEquals("Esports " + '\n' + "June 26, 2023 7pm" + '\n' + "Tournament " + '\n' + "Mattamy Athletic Center, Toronto Ontario, Canada",eventList.getEventByID(1).getEventDetails());
